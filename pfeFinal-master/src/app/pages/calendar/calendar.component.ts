...
// @ViewChild('modalShow') modalShow: TemplateRef<any>;
 ...
 getListSituation() {
   this.serv.GetCongeByMat( this.tokenService.getUser().matriculeP).subscribe(
     (data: any[]) => {
       this.rowData = data;
       console.log("******************",data)
       this.events=data.map((e:any)=>({title:e.typeConge.nomTypeconge,start:e.dateDebut,color:"orange"}))
